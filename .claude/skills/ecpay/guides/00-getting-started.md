...
| Node.js / Python / TypeScript | 本指南 → `lang-standards/{語言}.md` → guides/13 → guides/19 → guides/01（已有 Quick Start） |
| Go / Java / C# / Kotlin / Ruby | 本指南 → `lang-standards/{語言}.md` → guides/13 → guides/14 → guides/23（完整 E2E） |
| Swift / Rust | 本指南 → `lang-standards/{語言}.md` → guides/13 → guides/14 → guides/23（CLI 範例 + Mobile App） |
| C / C++ | 本指南 → `lang-standards/{語言}.md` → guides/13 → guides/14 → guides/19（HTTP 協議 → 自行整合） |
